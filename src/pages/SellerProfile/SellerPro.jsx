...
function SellerPro() {
  ...
  const showBankDetailsAlert = data && !data?.user?.KycProvidedDetails?.bankDetails;
      ...
      >
        ...
        >
          ...
          <Typography variant="body1">
            Manage your business details, documents, and banking information from this central dashboard.
          </Typography>
        </Box>

        {/* Alerts */}
        {(showVerificationAlert || showBankDetailsAlert || showDocumentAlert) && (
          <Box sx={{ p: 3, bgcolor: '#f8fafc' }}>
            {showVerificationAlert && (
              ...
              >
                ...
                Thank you for your registration! Your account is currently under review. 
                We will notify you once your profile has been approved by our team.
              </Alert>
            )}
            ...
            {showBankDetailsAlert && (
              ...
              >
                ...
                Please add your banking information to complete your registration and proceed with verification.
              </Alert>
            )}
            ...
            {showDocumentAlert && (
              ...
              >
                ...
                Please upload your PAN and GSTIN documents to complete your registration and proceed with verification.
              </Alert>
            )}
          </Box>
        )}
